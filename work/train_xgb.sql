CREATE MODEL Kaggle_Riiid.xgb_v1_5_fold0
...
AS SELECT 
  ...
  IFNULL(CAST(prior_question_had_explanation AS INT64), 0) AS prior_question_had_explanation,
  ...
  IFNULL(bundle_id, -1) AS bundle_id,
  IFNULL(part, -1) AS part,
