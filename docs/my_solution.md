...
|xgb_v17_03_f0||||Iter=300, Window=200の正解率, 特徴量追加→null importanceで選択した残りのやつv1,2|
|xgb_v17_04_f0||||Iter=300, Window=200の正解率, 特徴量追加→null importanceで選択した残りのやつv3,4|
|xgb_v17_05_f0||||Iter=300, Window=200の正解率, 特徴量追加, with answer std|
