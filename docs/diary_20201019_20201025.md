...
|v6_02|User Aggのみ+特徴量削減|0.6126|0.6018|[Notebook](https://www.kaggle.com/takamichitoda/riiid-xgboost-null-importance?scriptVersionId=45311812)|
|v6_03|User Aggのみ+特徴量削減||||
||Question Aggを追加||||
||Part Aggを追加||||
||Lecture Aggを追加||||
