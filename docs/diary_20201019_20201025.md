...
- target encodiing
  - task_container_id
  - bundle_id
- task_container_idのMAX, UniqueCount
...
#### v2特徴量追加 + Depth=8, COLSAMPLE_BYLEVEL=0.1, MIN_TREE_CHILD_WEIGHT=2 + でかいカテゴリ変数除去 + task_container_idをfix
- fold-0: 0.7435 / LB: 
