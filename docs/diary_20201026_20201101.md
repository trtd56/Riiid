...
### 少量データでもうまく回るらしい
-  [10%のデータで特徴量作成](https://www.kaggle.com/takamichitoda/riiid-sampling-and-extract-feature?scriptVersionId=45578017)
- 累計計算(cumsum)がうまくいった
...
|xgb_v7_04|0.5411|0.7557|[XX](https://www.kaggle.com/takamichitoda/riiid-xgboost-infer?scriptVersionId=45578193)|チューニング: Depth=5→7|
|xgb_v7_05||||チューニング: Depth=7→9|
